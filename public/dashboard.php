                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            ...
                            >
                              <h6 class="mb-0 text-sm">Note Title 1</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">This is the content of note 1.</p>
                        </td>
                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div
                              class="d-flex flex-column justify-content-center"
                            >
                              <h6 class="mb-0 text-sm">Note Title 2</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">This is the content of note 2.</p>
                        </td>
                        <td class="align-middle text-center">
                          <span class="text-secondary text-xs font-weight-bold"
                            >Work</span
            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                ...
                >
                  ...
                  , made with <i class="fa fa-heart"></i> by Secure Note Team.
                </div>
              </div>
              <div class="col-lg-6">
                <ul
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="noteForm">
              ...
              <div class="form-group">
                <label for="note-category" class="col-form-label"
                  >Category:</label
                >
    ...
    <script>
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          var encryptedContent = CryptoJS.AES.encrypt(
            content,
            "your-encryption-key"
          ).toString();
          ...
          contentCell.innerHTML =
            '<p class="text-sm">' + encryptedContent + "</p>";
          categoryCell.className = "align-middle text-center";
          ...
          document.querySelector("#noteModal .btn-secondary").click();
        });
      document
        .getElementById("saveNote")
        .addEventListener("click", function () {
          ...
          saveNoteToServer(title, encryptedContent, category);
        });

      function saveNoteToServer(title, content, category) {
        ...
        console.log("Saving note to server:", note);
      }
    </script>
  </body>
</html>
